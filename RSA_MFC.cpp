...
// RSA_MFC.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CRSA_MFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CRSA_MFCApp

CRSA_MFCApp::CRSA_MFCApp()
{
...
// Единственный объект CRSA_MFCApp

CRSA_MFCApp theApp;


// инициализация CRSA_MFCApp

BOOL CRSA_MFCApp::InitInstance()
{
